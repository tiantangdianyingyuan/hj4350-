    ...
    <el-card v-loading="loading" shadow="never" style="border:0" body-style="background-color: #f3f3f3;padding: 10px 0 0;">
        <div slot="header">
            <div flex="dir:left box:last cross:center">
                <el-breadcrumb separator="/">
                    ...
                    <el-breadcrumb-item>分类导入历史</el-breadcrumb-item>
                </el-breadcrumb>
                <div>
                    <form style="display: inline" target="_blank" :action_url="'<?= Yii::$app->request->baseUrl . '/index.php?r=' ?>' + 'mall/cat/import-cat-log'" method="post">
        ...
        <div class="table-body">
            ...
            <el-table border :data="list" style="width: 100%;margin-bottom: 15px">
                ...
                <el-table-column prop="count" label="上传分类总数"></el-table-column>
                <el-table-column prop="success_count" label="成功分类数"></el-table-column>
                <el-table-column prop="error_count" label="失败分类数"></el-table-column>
